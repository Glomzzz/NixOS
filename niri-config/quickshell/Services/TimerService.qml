...
Singleton {
    ...
    function playSystemSound(soundName) {
        const configuredRoot = Quickshell.env("CLAVIS_SOUND_DIR") ||
            "/usr/share/sounds/freedesktop/stereo";
        const soundRoot = configuredRoot.replace(/\/+$/, "") + "/";
