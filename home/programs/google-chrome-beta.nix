...
let
  ...
  linux = stdenvNoCC.mkDerivation (finalAttrs: {
    ...
    src = fetchurl {
      ...
      hash = "sha256-D9rejyXgo/8anHWKTq0+AqAX6Y8MbbVCcUiYGv/Ahbc=";
    };

    # With strictDeps on, some shebangs were not being patched correctly
    # ie, $out/share/google/chrome-beta/google-chrome-beta
    strictDeps = false;
    ...
    installPhase = ''
      ...
      substituteInPlace $out/share/applications/com.google.Chrome.beta.desktop \
        --replace-fail /usr/bin/google-chrome-$dist $exe
      substituteInPlace $out/share/applications/google-$appname.desktop \
        --replace-fail /usr/bin/google-chrome-$dist $exe
      substituteInPlace $out/share/gnome-control-center/default-apps/google-chrome-beta.xml \
      ...
      substituteInPlace $out/share/applications/com.google.Chrome.beta.desktop \
        --replace-fail 'Icon=google-chrome-beta' 'Icon=google-chrome'
  ...
  meta = {
    ...
    description = "Google Chrome Beta browser";
